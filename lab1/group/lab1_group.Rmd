...
```{r propteinplot, echo=FALSE, fig.width=5, fig.height=4, fig.cap="\\label{fig:fig5} Moisture vs protein"}
...
$$y \sim N \left( \sum \limits_{n=1}^i \omega_i x^i, \sigma^2 \right)$$
...
```{r fit_data3_lin, echo=FALSE,fig.width=5, fig.height=4, fig.cap="\\label{fig:fig6} MSE for diffrent $i$ in $M_i$"}
...
```{r ridge, echo=FALSE, fig.width=5, fig.height=4, fig.cap="\\label{fig:fig7} ridge coefficients over lambda"}
