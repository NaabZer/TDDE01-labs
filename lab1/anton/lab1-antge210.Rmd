...
```{r priorf, ig.width=5, fig.height=4, fig.cap="\\label{fig:fig3} log likelyhood for task 4"}
...
## Task 5
```{r hist, fig.width=5, fig.height=4, fig.cap="\\label{fig:fig4} Distribution histograms"}

  random_x = rexp(50, maxtheta)
  data2[,1]
  hist(data2, probability=TRUE)
  hist(random_x, probability=TRUE)
```